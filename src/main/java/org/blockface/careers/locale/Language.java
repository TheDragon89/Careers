...
public enum Language {
    ...
    RECEIVED_MONEY("notification.receivedmoney","You were paid %s for %s",0),
    SENT_MONEY("notification.sentmoney","You paid %s for %s",0),
    ...
    PACK_ANIMAL_SUCCESS("notification.packanimalsuccess", "You summoned your pack to help you!", 0)
    ;
